...
//             <h1 className="middle-text font-bold inter-font text-3xl mt-6">
//                 About The Instructor
//             </h1>
//             <p className="w-[60rem] pt-7 inter-font navy-text text-xl">
...
//                 thousands of DM’s and giving over a hindered lectures on this
