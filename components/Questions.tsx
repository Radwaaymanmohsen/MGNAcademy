...
//             <h1 className="middle-text font-bold inter-font text-2xl flex flex-col items-center  mb-7 mt-[4rem] ">
...
//                 className="w-[50rem] p-3 italic  rounded-lg shadow-md text-center  text-[#2967ae] mb-6"
//                 style={{
//                     whiteSpace: "nowrap",
//                     overflow: "hidden",
...
//                 }}
//             >
//                 <h1 className="text-2xl -bold mb-4">
...
//                 exit={{ opacity: 0 }}
//                 transition={{ duration: 1 }}
//                 className="w-[50rem] p-3 italic  rounded-lg shadow-md text-center  text-pink-400 mb-6"
//                 style={{
//                     whiteSpace: "nowrap",
//                     overflow: "hidden",
//                     textOverflow: "ellipsis",
...
//             <div className="flex flex-col items-start px-[30rem] pt-[2rem] overflow-y-auto">
//                 <p className="text-xl inter-font  font-bold navy-text pb-7 ">
